...
/**
 * Classe Piece √† nettoyer, c'est aussi un thread
 * @author S√©bastien
 */
public class Piece extends Thread
{
    ...
    /** 
     * @return Les dimensions de la piËce sous forme de tableau d'entier. Indice 0=largeur/1=Longueur
     */
     ...
     * @param x
     * @param y
     * @return l'indice, -2 si non trouvÈ
     */
     ...
     * @param x
     * @param y
     * @return la Position si elle est trouvÈ, null sinon.
     */
    ...
    */
    ...
    /**
    * Rempli un vector de toutes les positions possibles dans la pi√®ce
    */
    ...
    /**
     * MÈthode run de la thread Piece, charge la piËce contenu dans piece.txt. 
     * VÈrifie ensuite que toute la poussiËre ait ÈtÈ aspirÈe.
     */
    @Override
    public void run()
    {
